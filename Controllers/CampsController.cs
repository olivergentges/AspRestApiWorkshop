...
namespace AspRestApiWorkshop.Controllers
{
    ...
    public class CampsController : ControllerBase
    {
        ...
        private CampModel CreateLinksForCamp(CampModel campModel)
        {
            ...
            campModel.Links.Add(new LinkDto(
                _linkGenerator.GetUriByAction(HttpContext, "GetTalks", "talks", new { moniker = campModel.Moniker }),
                "get_talks_from_camp",
                "GET"));
            ...
            campModel.Links.Add(new LinkDto(
                _linkGenerator.GetUriByAction(HttpContext, "UpdateCamp", "camps", new { moniker = campModel.Moniker }),
                "update_camp",
                "PUT"));
